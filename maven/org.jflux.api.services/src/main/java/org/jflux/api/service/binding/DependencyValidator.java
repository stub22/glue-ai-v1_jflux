...
public class DependencyValidator {
	private static final Logger theLogger = LoggerFactory.getLogger(DependencyValidator.class);
	 ...
	 * @return true if there is a dependency in the map for each descriptor, false if one or more
	 * descriptors is not filled
	 */
...
//                    descriptor.getDependencyType();
	 ...
	 * @return true if there is a Descriptor with the given dependency id
	 */
