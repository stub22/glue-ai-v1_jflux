...
public class ConnectionConfigUtils {
	private static final Logger theLogger = LoggerFactory.getLogger(ConnectionConfigUtils.class);
	...
	public static Configuration<String> buildConnectionConfig() {
		DefaultConfiguration<String> conf = new DefaultConfiguration<>();
	...
	public static class ConnectionFactory implements
		...
		public Connection adapt(Configuration<String> a) {
			try {
				...
				theLogger.warn("Unable to start connection.", ex);
				return null;
			}
		}
	}
