...
public class XMLUtils {
	private static final org.slf4j.Logger theLogger = LoggerFactory.getLogger(XMLUtils.class);
	/**
	...
	public static void skipElement(XmlPullParser xpp) throws XmlPullParserException, IOException {
		...
		theLogger.trace("Skipping Element: {}", name);
