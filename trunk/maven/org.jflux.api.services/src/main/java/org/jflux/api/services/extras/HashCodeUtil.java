...
public class HashCodeUtil {
     ...
     * contributions from fields. Using a non-zero value decreases collisions 
     ...
     * @param aSeed HashCode seed
     * @param objs Objects to hash
     * @return HashCode made from Objects
     */
    public static int hash(int aSeed, Object ...objs) {
        int result = aSeed;
        for(Object obj : objs){
            result =  hash(result, (obj == null ? 0 : obj));
        }
        return result;
    }
}
