...
public class XMLConfigUtils {
    private final static Logger theLogger = Logger.getLogger(XMLConfigUtils.class.getName());
    /**
     ...
     * @return Integer from the given XML node.  <code>def</code> if an Integer 
     * cannot be read
     */
     ...
     * @return Double from the given XML node.  <code>def</code> if a Double 
     * cannot be read
     */
     ...
     * @return Boolean from the given XML node.  <code>def</code> if a Boolean 
     * cannot be read
     */
     ...
     * @return String from the given XML node.  <code>def</code> if a String 
     * cannot be read
     */
